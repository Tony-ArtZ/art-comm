...
const Hero = ({user, userData, likeCount}: {user: User, userData:any, likeCount:null|number;}) => {
  ...
  return (
    <header className="w-screen 2xl:h-[870px] xl:h-[750px] sm:h-[600px] bg-hero bg-cover h-[400px] ">
      ...
      />
      <NavBar user={user} userData={userData} signOut={signOut} router={router} likeCount={likeCount} search={handleSearch} handleSearchInput={handleSearchInput} value={""}/>
