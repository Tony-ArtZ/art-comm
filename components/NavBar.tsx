...
export default function NavBar ({user, userData, signOut, likeCount, search, handleSearchInput, value}: {user: User, userData: any, likeCount:null|number, signOut: (e:React.MouseEvent<HTMLButtonElement>)=>Promise<void>, router:NextRouter, search:()=>void, handleSearchInput:(value:string)=>void, value:string|null}) {
